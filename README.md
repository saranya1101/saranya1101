...
| ☁️ [Cloud-Based Student Management System](https://github.com/saranya1101/cloud-based-student-management-system.git) | RESTful APIs with role-based access control, containerized and deployed on AWS EC2 via Docker/Kubernetes, provisioned with Terraform, CI/CD via GitHub Actions | Spring Boot, MySQL, AWS, Docker, Kubernetes, Terraform |
